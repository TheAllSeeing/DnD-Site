...
<body style="background: url(../../../Images/SubjectBackground.jpg) no-repeat fixed 100% 0;">
    <form id="form1" runat="server">
        ...
        <p>
            <span style="font-weight:bold">For the subject of my website, I choose <span style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;font-size:14.5px;color:red;" ;>Dungeons and Dragons.</span></span> (or <i>D&D</i> for short).
            <br />
